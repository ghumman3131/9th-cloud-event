...
public class addDj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dj_recycler.setLayoutManager(new LinearLayoutManager(addDj.this , LinearLayoutManager.VERTICAL, false));
    }

    public void add_dj_Details(View view) {

        startActivity( new Intent(addDj.this , DjDetails.class));
    }
    public void get_dj()
    {
            ...
            holder.dj_lay.setOnClickListener(new View.OnClickListener() {
               @Override
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(addDj.this,updateDj.class);
